            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                                ...
                                <ul class="menu">
                                    <li>
                                        <a href="javascript:void(0);">
                                            <img src="{{URL::to('assets/images/avatars/face4.jpg')}}" alt="User Avatar" />
                                            <div class="info">
                                                <h4>John Doe</h4>
                                                <span class="time">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <img src="{{URL::to('assets/images/avatars/face5.jpg')}}" alt="User Avatar" />
                                            <div class="info">
                                                <h4>Francisco Day</h4>
                                                <span class="time">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <img src="{{URL::to('assets/images/avatars/face6.jpg')}}" alt="User Avatar" />
                                            <div class="info">
                                                <h4>Maria Doe</h4>
                                                <span class="time">
                                                            <i class="material-icons">access_time</i> 1 hour ago
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <img src="{{URL::to('assets/images/avatars/face7.jpg')}}" alt="User Avatar" />
                                            <div class="info">
                                                <h4>Connie Craig</h4>
                                                <span class="time">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <img src="{{URL::to('assets/images/avatars/face8.jpg')}}" alt="User Avatar" />
                                            <div class="info">
                                                <h4>Agnes Howard</h4>
                                                <span class="time">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            <img src="{{URL::to('assets/images/avatars/face9.jpg')}}" alt="User Avatar" />
                                            <div class="info">
                                                <h4>Gina Fletcher</h4>
                                                <span class="time">
                    ...
                    <li class="dropdown user-menu">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{URL::to('assets/images/avatars/face2.jpg')}}" alt="User Avatar" />
